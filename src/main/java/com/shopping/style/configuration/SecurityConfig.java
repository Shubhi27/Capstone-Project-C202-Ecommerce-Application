...
import com.shopping.style.services.CustomUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/", "/shop/**", "/register", "/h2-console/**","/admin").permitAll()
				.and().formLogin()
				...
				.successHandler(googleSuccessHandler).and().logout()
